...
exports.removeByType = exports.hideConfirm = exports.showConfirm = exports.update = exports.remove = exports.clean = undefined;
exports.add = add;
...
var update = exports.update = function update(payload) {
  return {
    type: _constants.UPDATE_CONTENT_TOASTR,
    payload: payload
  };
};
