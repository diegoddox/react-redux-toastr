...
exports.default = (0, _utils.createReducer)(initialState, (_createReducer = {}, _defineProperty(_createReducer, _constants.ADD_TOASTR, function (state, toastr) {
  ...
  exports.toastrsCache = toastrsCache = newState.toastrs;
  return newState;
}), _defineProperty(_createReducer, _constants.UPDATE_CONTENT_TOASTR, function (state, _ref) {
  var id = _ref.id,
      payload = _ref.payload;

  return _extends({}, state, {
    toastrs: state.toastrs.map(function (toastr) {
      return toastr.id === id ? _extends({}, toastr, payload) : toastr;
    })
  });
