...
var ToastrBox = (function (_Component) {
  ...
  function ToastrBox(props) {
    ...
    (0, _utils._bind)(_this, 'mouseEnter', 'mouseLeave', 'handleClick', 'removeToastr', 'onAnimationComplite', '_setTransition', '_clearTransition', '_setIntervalId', '_setIsHiding');
    return _this;
  }
  ...
  _createClass(ToastrBox, [{
    ...
    value: function componentDidMount() {
      ...
      _ReactTransitionEvents2.default.addEndEventListener(node, this.onAnimationComplite);
    ...
    key: 'onAnimationComplite',
    value: function onAnimationComplite() {
      ...
      if (this.isHiding) {
        ...
        _ReactTransitionEvents2.default.removeEndEventListener(this.toastrBox, this.onAnimationComplite);
        remove(toastr.id);

        if ((0, _utils.hasProperty)(toastr.options, 'onHideComplete')) {
          toastr.options.onHideComplete && toastr.options.onHideComplete();
        }
      } else if (!this.isHiding) {
        if ((0, _utils.hasProperty)(toastr.options, 'onShowComplete')) {
    ...
    value: function render() {
      ...
      if ((0, _utils.hasProperty)(toastr.options, 'icon')) {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: 'redux-toastr-message-holder', onClick: this.handleClick },
